...
export async function getDashboardData() {
  ...
  const [totalBalance , totalIncome , totalExpenses , totalInvestments, totalLoans] = await Promise.all([
    getTotalBalance(session.accessToken, start, end),
    getTotalIncome(session.accessToken, start, end),
    getTotalExpenses(session.accessToken, start, end),
    getTotalInvestments(session.accessToken, start, end),
    getTotalLoans(session.accessToken, start, end),
  ])
