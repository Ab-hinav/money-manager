      ...
      <div className="px-3 py-2 flex-1">
        <div className="flex items-center justify-between mb-14 px-2">
            ...
            {!collapsed && setCollapsed && (
                <Button variant="ghost" size="icon" onClick={() => setCollapsed(!collapsed)} aria-label="Collapse sidebar" aria-expanded={true} className="h-auto w-auto p-1 text-muted-foreground hover:text-foreground">
                    <ChevronLeft size={18} />
                </Button>
            )}
        </div>
        ...
        {collapsed && setCollapsed && (
             <Button variant="ghost" size="icon" onClick={() => setCollapsed(!collapsed)} aria-label="Expand sidebar" aria-expanded={false} className="mb-4 w-full h-auto py-2 text-muted-foreground hover:text-foreground">
